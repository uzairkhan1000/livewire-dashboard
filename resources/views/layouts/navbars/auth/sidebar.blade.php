<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    ...
    <div>
    <ul>
    <li wire:click="$emit('loadView', 'default')">Default Content</li>
        <li wire:click="setActiveLinkView('link1')">Link 1</li>
        <li wire:click="setActiveLinkView('link2')">Link 2</li>
        <li wire:click="setActiveLinkView('link3')">Link 3</li>
    </ul>
</div>
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'add-product' ? 'active' : '' }}" href="{{ route('add-product') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-cart-plus ps-2 pe-2 text-center
                        {{ Route::currentRouteName() == 'add-product' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item">
            <a class="nav-link {{ Route::currentRouteName() == 'product-listing' ? 'active' : '' }}" href="{{ route('product-listing') }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ Route::currentRouteName() == 'product-listing' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
