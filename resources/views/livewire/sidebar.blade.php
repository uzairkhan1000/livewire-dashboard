<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
    <div class="sidenav-header">
        {{-- @dd($this->getIconClass('food')) --}}
        <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" wire:click="setActiveLinkView('dashboard')">
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            {{-- <li class="nav-item pb-2" wire:click="setActiveLinkView('dashboard')">
                <a class="nav-link {{ $activeView == 'dashboard' ? 'active' : '' }}">
            ...
            @foreach($sidebar_items as $item => $value)
                @if(is_array($value))
                    <li class="nav-item mt-2">
                        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">{{$item}}</h6>
                    </li>
            ...
            {{-- <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Product</h6>
            </li>
            <li class="nav-item" wire:click="setActiveLinkView('product.add-product-form')">
                <a class="nav-link {{ $activeView == 'product.add-product-form' ? 'active' : '' }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <li class="nav-item" wire:click="setActiveLinkView('product.product-listing')">
            <a class="nav-link {{ $activeView == 'product.product-listing' ? 'active' : '' }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ $activeView == 'product.product-listing' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Product Listing</span>
                </a>
            </li>

            <li class="nav-item mt-2">
                <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Order</h6>
            </li>
            <li class="nav-item" wire:click="setActiveLinkView('order.add-order')">
                <a class="nav-link {{ $activeView == 'order.add-order' ? 'active' : '' }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-cart-plus ps-2 pe-2 text-center
                        {{ $activeView == 'order.add-order' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">Add Order</span>
                </a>
            </li>

            <li class="nav-item" wire:click="setActiveLinkView('order.all-orders')">
            <a class="nav-link {{ $activeView == 'order.all-orders' ? 'active' : '' }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ $activeView == 'order.all-orders' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
            ...
            <li class="nav-item" wire:click="setActiveLinkView('roles.all-roles')">
                <a class="nav-link {{ $activeView == 'roles.all-roles' ? 'active' : '' }}">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center
                        {{ $activeView == 'roles.all-roles' ? 'text-white' : 'text-dark' }}"></i>
                    </div>
                    <span class="nav-link-text ms-1">All Roles</span>
                </a>
            </li> --}}
